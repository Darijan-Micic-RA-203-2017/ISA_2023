...
public class EquipmentOrderConverter {
	...
	public static List<EquipmentOrderDTO> convertToDTOsList(Iterable<EquipmentOrder> equipmentOrders) {
	...
	public static EquipmentOrderDTO convertToDTO(EquipmentOrder equipmentOrder) {
		...
		List<DetailsOfEquipmentOrderDTO> details = 
				DetailsOfEquipmentOrderConverter.convertToDTOsList(equipmentOrder.getDetails());
