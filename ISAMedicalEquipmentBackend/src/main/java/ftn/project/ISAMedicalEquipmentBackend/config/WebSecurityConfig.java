...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
				...
				.antMatchers("/medical-equipment/of-company/{company_name}").authenticated()
				.antMatchers("/medical-equipment/search-by-name").permitAll()
				.antMatchers("/medical-equipment/search-by-name/of-company/{company_name}").authenticated()
				...
				.antMatchers("/exchange-terms/on-specific-date-of-company/{company_id}").authenticated()
				.antMatchers("/exchange-terms/of-company/{company_id}").authenticated()
				...
				.antMatchers("/ordering/cancel-order?exchange_term_id={exchange_term_id}&procurement_manager_id={procurement_manager_id}")
						.access("hasRole(\"SYSTEM_ADMINISTRATOR\") OR @webSecurityConfig.hasId(#procurement_manager_id)")
